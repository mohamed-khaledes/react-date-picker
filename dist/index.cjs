...
function ReactDatePicker({
  ...
  const [selectedDate, setSelectedDate] = (0, import_react.useState)(value || null);
  const [activeCalendar, setActiveCalendar] = (0, import_react.useState)(defaultCalendar);
  const [hijriDisplay, setHijriDisplay] = (0, import_react.useState)(
    () => selectedDate ? gregorianToHijri(selectedDate) : gregorianToHijri(/* @__PURE__ */ new Date())
  );
  const [gregorianDisplay, setGregorianDisplay] = (0, import_react.useState)(
  ...
  const renderCalendar = (isHijri) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "select",
            {
              ...
              children: monthNames.map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: i + 1, children: m }, i))
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "select",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
        ...
        gap: "4px",
        marginBottom: "8px"
      }, children: weekdays.map((day, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: {
        textAlign: "center",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref, style: { position: "relative", width: "100%" }, className, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarIcon, { style: {
        position: "absolute",
    ...
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          allowCalendarSwitch && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
            display: "flex",
            gap: "8px",
            marginBottom: "16px",
            background: themeColors.surface,
          ...
          showBothCalendars ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: "16px", flexWrap: "wrap" }, children: [
            renderCalendar(true),
          ...
          selectedDate && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
            marginTop: "16px",
            padding: "12px",
            background: themeColors.surface,
            borderRadius: radiusClass,
